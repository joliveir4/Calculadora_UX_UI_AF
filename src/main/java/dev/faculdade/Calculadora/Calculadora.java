package dev.faculdade.Calculadora;
 ...
 *
 * @author João Paulo de Oliveira Pereira
 * @version 1.0
 */
public class Calculadora {
     ...
     * @param a primeiro operando
     * @param b segundo operando
     * @return o resultado da subtração de {@code b} subtraído de {@code a}
     */
     ...
     *
     * <p>Este método lança uma exceção caso o divisor ({@code b}) seja zero,
     * pois a divisão por zero não é permitida.</p>
     *
     * @param a dividendo
     * @param b divisor
